...
const initialState = [
    {
        id: 1, 
        title: "\"Nu verdwalen de nachten in jou\": Antwerps stadsdichter Lies Van Gasse brengt ode aan Reinhilde Decleir","description": "Antwerps stadsdichter Lies Van Gasse heeft een gedicht geschreven als eerbetoon aan Reinhilde Decleir, de actrice die eerder deze week stierf. Theatergezelschap Tutti Fratelli in Antwerpen, dat Decleir oprichtte, is nog de hele dag open voor wie haar wil gedenken.",
...
const contentSlice = createSlice({
  ...
  reducers: {
      ...
      contentUpdated(state, action) {
          ...
          const existingContent = state.find(newsItem => newsItem.id == id)
          if (existingContent) {
...
export const { contentAdded, contentUpdated } = contentSlice.actions
